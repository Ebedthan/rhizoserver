...
<body class="d-flex flex-column min-vh-100">
    ...
    <?php
        ...
        //$data = new BaktaJSON("annotations/" . $_GET["gid"] . ".json"); 
            ...
            <div class="col-2">
                <div class="card border-darks text-center mt-5">
                    ...
                    <div class="card-body text-dark">
                        ...
                        <a href=<?php echo "https://www.ncbi.nlm.nih.gov/data-hub/genome/".$_GET["gid"]; ?> target="_blank"><img src="assets/images/ncbi.svg" width="100px" height="auto" class="img-thumbnail" alt="ncbi link"></a><br/><br/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="value col-md-8"><?php echo 0; ?></div>
                                </div>
                                <div class="row">
                                    <div class="label col-md-4">Genome size:</div>
                                    <div class="value col-md-8"><?php echo 1; ?></div>
                                </div>
                            </div>
                        </div>
                        <!--
