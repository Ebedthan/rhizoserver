            ...
            <div class="col-4">
                <div class="card border-darks mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-2">
                            <div class="col-auto">
                                <textarea class="form-control-plaintext" id="codeDT" rows="2"><?php echo "datasets download genome accession " . $_GET["gid"]; ?></textarea>
                            </div>
                            <div class="col-auto align-self-center">
